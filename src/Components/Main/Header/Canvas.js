...
const Canvas = () => {
    ...
    var canvas2 = document.getElementById("canvas2"),
        ...
        context2.font = "bold 20px";
        context2.fillStyle = "rgb(255,255,255)";
        context2.fillText("asdasd", 50, 100);
...
function start() {
    ...
    var canvas = document.getElementById("canvas"),
        ...
        shootingStars = [],
        layers = [
            { speed: 0.025, scale: 0.2, count: 340 },
            { speed: 0.04, scale: 0.5, count: 65 },
            { speed: 0.06, scale: 0.75, count: 43 }
        ],
        starsAngle = 145,
        shootingStarSpeed = {
            min: 15,
